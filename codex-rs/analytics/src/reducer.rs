...
pub(crate) struct AnalyticsReducer {
    ...
    tool_item_started_at_ms: HashMap<ToolItemKey, u64>,
}
    ...
    fn ingest_notification(
        ...
        match notification {
            ServerNotification::ItemStarted(notification) => {
                ...
                self.tool_item_started_at_ms.insert(
            ...
            ServerNotification::ItemCompleted(notification) => {
                ...
                let Some(started_at_ms) = self.tool_item_started_at_ms.remove(&ToolItemKey::new(
